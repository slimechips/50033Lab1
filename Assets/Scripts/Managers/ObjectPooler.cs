...
public class ObjectPooler : MonoBehaviour
{
    ...
    {
        var a = pooledObjects;
        return pooledObjects.Count(x => x.gameObject.activeInHierarchy);
    }
    ...
    {
        // Dont give anything if there are too many objects already
        if (GetActiveCount() + 1 > constants.spawnMax)
        {
